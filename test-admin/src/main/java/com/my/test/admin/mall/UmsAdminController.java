...
import com.my.test.model.UmsAdmin;
import com.my.test.model.UmsPermission;
import com.my.test.model.UmsRole;
...
public class UmsAdminController {
    ...
    //TODO  根据注解权限管理
    @PreAuthorize("hasAuthority('admin:getOne')")
